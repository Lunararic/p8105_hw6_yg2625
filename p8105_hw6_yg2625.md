...
![](p8105_hw6_yg2625_files/figure-markdown_github/unnamed-chunk-11-1.png) By the plot, we could see that although there are several extremely high residual points, most of the datapoints generally spread out and bounce around the 0 line and the relationship is reasonable.
...
Based on the CV output, make further comparison using violin plot
